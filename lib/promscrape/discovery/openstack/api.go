...
const authHearName = "X-Auth-Token" // for making requests to openstack api
...
type apiConfig struct {
	...
	allTenants bool
	region     string
	// availability public, private, admin for filtering compute endpoint
	availability string
}
